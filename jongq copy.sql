...
--
-- Host: db
-- Generation Time: Apr 10, 2023 at 01:13 PM
...
CREATE TABLE `tb_barbershop_informations` (
  ...
  `bi_channel_access_token_line` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bi_line_oa` text NOT NULL,
  `bi_line_oa_qr` text NOT NULL,
  `bi_line_channel_secret` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bi_link_oa_add_friend` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bi_channel_id` varchar(150) NOT NULL
...
INSERT INTO `tb_barbershop_informations` (`id`, `bi_name`, `bi_tel`, `bi_profile`, `bi_email`, `bi_line`, `bi_descriptions`, `bi_shop_owner`, `bi_line_token`, `ip_address`, `bi_status`, `bi_channel_access_token_line`, `bi_line_oa`, `bi_line_oa_qr`, `bi_line_channel_secret`, `bi_link_oa_add_friend`, `bi_channel_id`) VALUES
(1, 'หัวล้านตัดได้', '061-456-8963', '1.jpg', 'email@gmail.com', 'line-id***', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad im veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip', 'Alva Adition Alva Adition', '8YXQMYZMXWK0F0GTY15TBNQN4z9nr5h23WVmJ7VA9Cx', 'https://0cb2-2001-44c8-42ce-e77c-e8cc-3f1b-a95b-e26f.ngrok-free.app/', 1, 'VmIYbkUHUpFbORI9lRPOkpU439DLzjpYu//6MM34iRH9i01/fNtrZPQxnFQQgsdUNvAR+IcTrQ8w1uT1eCdI3NA2DT4CRn/CBt2bt8NqkjbIn1cfzv1xcqRpTuQYt3Afzur+IuplzrvoDilEE8Ik9wdB04t89/1O/w1cDnyilFU=', '@127aipgw', 'https://qr-official.line.me/gs/M_127aipgw_GW.png', '1ad104e9546e167f1b7bf0554a433db5', 'https://lin.ee/wr2e2F6', '1660852559');
...
CREATE TABLE `tb_users` (
  ...
  `line_user_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `tb_users` (`id`, `full_name`, `tel`, `username`, `email`, `password`, `profile`, `user_role`, `line_user_id`) VALUES
(3, 'docker update', '0611233657', 'docker_update', 'dockerupdate@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '6416e1c7a43962023-03-19 10:19:512022-09-11.png', 'USER', 'Uf8aa8ac888821125a4e18b66a394095a'),
